        ...
        switch (x) {
            ...
            case 1:
                while (true) {
                    ...
                    System.out.println("3. Удаления студента по его айди");
                    System.out.println("4. Добавить студента в базу данных");
                    System.out.println("5  Найти студента по айди");
                    System.out.println("6. Обновить айди студента");
